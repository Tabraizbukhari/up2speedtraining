...
class CreateExamsromsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('examsroms', function (Blueprint $table) {
            ...
            $table->string('ev1notes',25)->nullable();
            $table->string('ev2observed',5)->nullable();
            $table->string('ev2painint',5)->nullable();
            $table->string('ev2notes',25)->nullable();
            $table->string('ev3observed',5)->nullable();
            $table->string('ev3painint',5)->nullable();
            $table->string('ev3notes',25)->nullable();//Elbow Rom
            $table->timestamps();
        });
    }
    ...
    {
        Schema::table('examsroms', function(Blueprint $table)
        {
            $table->dropForeign('patient_id'); 
        });

        Schema::dropIfExists('examsroms');
    }
}
