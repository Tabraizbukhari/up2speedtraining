    ...
    <div style="position:fixed;top:0px;left:0px;z-index:1">
        <table width="100%" height="52" border=0 cellspacing=0 cellpadding=5 style="background-color:#5f5f61;color:white;">
            <tr height="50">
                <td>
                    <a href="">
                        <img src="{{ asset('assets/demo2/nlimages/up2speedsmall.png') }}" width="116" height="30"></a>
                    </td>
    ...
    <table width="100%" height="100%" cellspacing="0" cellpadding="0" bgcolor="#f1f1f1">
        <tr width="100%" height="100%">
            ...
            <td width="100%" height="100%" valign="middle" align="center">
                <div style="width:800px;height:495px;background-image:url('assets/demo2/nlimages/rounded.png');">
                    <form method="POST" action="{{ route('login') }}">
                    @csrf
                        <input type="hidden" name="submit" value="true">
                        <br><br><br>
                        <table width="785"><tr><td width="100%" align="center" bgcolor="#f1f1f1"><hr><font size="+2">Login</font><hr></td></tr>
                        ...
                        <tr><td align="center" width="100%">
                            ...
                            <table width="300" bgcolor="white" style="border:1px black solid;">
                                ...
                                <tr><td colspan="2" align="center"><input type="image" src="{{ asset('assets/demo2/nlimages/loginbutton.png') }}"></td></tr>
