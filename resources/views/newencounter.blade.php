...
<div id="">
	<table id="dynamicTable" cellspacing="0" cellpadding="2"><tbody><tr><td style="font-size:24px" width="75"><b>#1:</b></td><td style="font-size:24px"><select name="addmore[0][datemonth]" id="" style="width:60px;height:40px;font-size:24px" onchange="changeforward(0)"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9" selected="">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>
<select name="addmore[0][dateday]" id="" style="width:60px;height:40px;font-size:24px"><option value="1">1</option><option value="2" selected="">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select>
...
<br><button type="button" name="add" id="add" class="btn btn-success">Add More</button>
<div id="showalgorithm" style="font-size:20px;">
<table width="500">
<tbody><tr><td colspan="4"><br></td></tr>
<tr><td colspan="4" style="font-size:20px;"><br><br>
<input type="hidden" name="encounter" value="newvisit"><input type="checkbox" name="initialexam" value="true" checked=""> Populate initial exam IL-99202 NE<br><br>No previous visits to use to populate.</td><td></td></tr></tbody></table>
<div id="notnewvisit" style="display:none;"><table><tbody><tr>
...
<br><br>
<input type="image" src="{{ asset('assets/demo2/nlimages/savebutton.png') }}" height="25">
</form>
