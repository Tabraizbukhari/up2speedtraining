...
<tr><td "="" align="center">
	<img src="{{ asset('assets/demo2/nlimages/patientinformation.png') }}"></td></tr><tr height="35">
		<td background="{{ asset('assets/demo2/nlimages/navbgactive.png')}}" style="background-repeat:no-repeat;background-position:center;" id="ientinfo.phptd" align="center"><b><a href="" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Patient Info</div></a></b></td></tr>
...
<div id="">
	<table id="dynamicTable" cellspacing="0" cellpadding="2">
		<tbody>
			<tr>
				<td style="font-size:24px" width="75"><b>#1:</b></td><td style="font-size:24px"><select name="addmore[0][datemonth]" id="" style="width:60px;height:40px;font-size:24px" onchange="changeforward(0)">
					<option value=""></option>
...
<select name="addmore[0][dateyear]" id="" style="width:120px;height:40px;font-size:24px" onchange="changeforward(0)">
	<option value=""></option>
...
</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time : <input id="time0" name="addmore[0][time]" style="width:100px;height:40px;font-size:24px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td style="font-size:24px">Billing Type : <select name="addmore[0][billingtype]" id="billingtype0" style="font-size:24px;">
	<option value=""></option>
	<option value=""></option>
</select>
...
<input type="hidden" name="" value="newvisit"><input type="checkbox" name="initialexam" value="true" checked=""> Populate initial exam IL-99202 NE<br><br>No previous visits to use to populate.</td><td></td></tr></tbody></table>
