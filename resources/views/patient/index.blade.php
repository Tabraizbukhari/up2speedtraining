...
<head>
  ...
  <link href="{{ asset('assets/demo/styles.css') }}" type="text/css" rel="stylesheet">
</head>
...
function showvisitdates(){
  if(document.getElementById(' visitdropdown').style.display=='none' ) document.getElementById('visitdropdown').style.display='block' ; else if(document.getElementById('visitdropdown').style.display=='block' ) document.getElementById('visitdropdown').style.display='none' ; } </script> <form name="encform" action="" method="">
  <div style="position:fixed;top:0px;left:0px;z-index:1;width:100%">
    <table id="mainmenutable" style="background-color:#5f5f61;color:white;background-image:url('assets/demo2/nlimages/headerbg.png');background-repeat:repeat-x;" width="100%" height="50" cellspacing="0" cellpadding="5" border="0">
      <tbody>
        <tr height="50">
            ...
            <table style="color:white;">
              <tbody>
                <tr style="padding:0px;">
                  <td style="padding:0px;" width="150" valign="middle" align="center"><a href="">
                      <img src="{{ asset('assets/demo2/nlimages/up2speedsmall.png') }}" style="display:inline;" height="50"></a></td>
                  <td width="20"></td>
                  <td width="50" valign="middle" align="left"><a href="{{ route('logout') }}">
                      <img src="{{ asset('assets/demo2/nlimages/logouticon.png') }}" height="60"></a></td>
          ...
          <td style="border-right:none;" id="tdpatientvisit" width="50%" valign="middle" align="center">
            <script>
              if (window.innerWidth < 1280) document.getElementById('tdpatientvisit').style.textAlign = 'center';
            </script>
            ...
            <form name="headerform" action="" method="" style="display:inline">
              <font size="+1">Please select a patient to begin!</font>&nbsp;&nbsp;&nbsp;<select name="patientid" id="headerpatientid" style="width:150px" onchange="location = this.value;">
          ...
          <td width="12%" align="right">
            <a href="{{ route('portalhome')}}" style="color:white;font-size:18px;">
              <img src="{{ asset('assets/demo2/nlimages/patientportal.png') }}" style="display:inline;" width="65"></a></td>
          <td style="border-left:none;" width="4%" align="right"><img src="{{ asset('assets/demo2/images/spacer.png') }}" width="65"></td>
        </tr>
  ...
  <table height="77">
    <tbody>
      <tr>
        <td><img src="{{ asset('assets/demo2/images/spacer.png') }}" height="77"></td>
      </tr>
    </tbody>
  </table>
    ...
    <tbody>
      <tr>
        <td width="238" valign="top" bgcolor="#f1f1f1">
          <img src="{{ asset('assets/demo2/images/spacer.png') }}" width="238" height="1">
          <div id="sidebar" style="position:fixed;top:0px;left:0px;width:238px;height:100%;background-color:#f1f1f1;overflow-y:auto;overflow-x:hidden;">
            ...
            <table style="background-color:#f1f1f1;" width="238" cellspacing="0" cellpadding="5" border="0">
              <tbody>
                    ...
                    <table width="200">
                      <tbody>
                        <tr>
                          ...
                          <td style="width:50px;padding:0px;" valign="middle" align="center"> </td>
                        </tr>
                        <tr>
                          <td valign="top" align="center"><a style="color:black;text-decoration:none;" href="?print=true">PRINT</a></td>
                ...
                <tr height="35">
                  <td style="background-image:url('assets/demo2/nlimages/navbgactive.png');background-repeat:no-repeat;background-position:center;" id="age.phptd" align="center"><b><a href="{{ route('patient') }}" style="color:white;text-decoration:none;">
                ...
                <tr height="35">
                  <td style="background-image: url('assets/demo2/nlimages/navbgpatient.png'); background-repeat: no-repeat; background-position: center center;" id="eduler.phptd" onmouseover="changebg('eduler.php','on','patient');" onmouseout="changebg('eduler.php','off','patient')" align="center"><a href="{{ route('scheduler') }}" style="color:white;text-decoration:none;">
                        ...
                        <tr>
                          ...
                          <td width="50%" align="right">
                            <table class="no-print">
                              <tbody>
                                <tr>
                                  <td align="center"><a href="{{ route('newpatient') }}">
                                      <img src="{{ asset('assets/demo2/nlimages/newpatient.png') }}" height="50"><br><br>New Patient</a></td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                  <td align="center"><a href="javascript:newencountersubmit();">
                                      <img src="{{ asset('assets/demo2/nlimages/newvisit.png') }}" height="50"><br><br>New Visit</a></td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                  <td align="center"><a href="javascript:printsubmit();"><img src="{{ asset('assets/demo2/nlimages/printicon.png') }}" height="50"><br><br>Print</a></td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
                                ...
                                <table width="100%">
                                  <tbody>
                                    <tr>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td colspan="2"><input type="radio" name="showonly" value="cash"> Cash Patients
                                                ...
                                                <input type="radio" name="showonly" value="pi"> PI Patients</td>
                                            </tr>
                                            <tr>
                                              ...
                                              <td><b>Select range:</b> <input type="radio" name="selectrange" value="visits" checked=""> Visits <input type="radio" name="selectrange" value="lastaccessed"> Last accessed</td>
                                            </tr>
                                            <tr>
                                              <td></td>
                                              <td>
                                              ...
                                              <td>
                                                <table>
                                                  <tbody>
                                                    <tr>
                                                      <td></td>
                                                      <td><input type="radio" name="last" value="Today"> Today</td>
                                                      <td><input type="radio" name="last" value="Yesterday"> Yesterday </td>
                                                    </tr>
                                                    <tr>
                                                      <td>Last:</td>
                                                      <td><input type="radio" name="last" value="3 Days"> 3 Days</td>
                                                      <td><input type="radio" name="last" value="Week"> Week</td>
                                                      <td><input type="radio" name="last" value="Month"> Month</td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              </td>
                                      ...
                                      <td valign="top" align="center"><br><input type="image" alt="Filter" src="{{ asset('assets/demo2/nlimages/filterbutton.png') }}" width="101"></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <tr>
                          <td>
                            ...
                            <table>
                              <tbody>
                                <tr>
                                  <td>Sort by: <select name="sortby" onchange="javascript:submitsort();" id="sortby">
                  ...
                  <form name="form" action="" method="" autocomplete="off" onsubmit="javascript:starsubmit();bpsubmit();phonesubmit();">
                    ...
                    <center>
                          ...
                          <tr>
                            ...
                            <td width="2%" align="left">
                              <table>
                                <tbody>
                                  <tr>
                                    <td><img src="{{ asset('assets/demo2/nlimages/starfirst.png') }}" onclick="starfirstsubmit('no');" height="20"></td>
                                    <td>
                                      <img src="{{ asset('assets/demo2/nlimages/phonefirstinactive.png') }}" onclick="phonefirstsubmit('yes');" height="20"></td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                            ...
                            <td class="no-print" width="10%" align="center"><b>Shortcuts</b></td>
                            <td class="no-print" width="10%" align="center"><b>Delete</b></td>
                          </tr>
                        </tbody>
                      </table>
                      <script>
                        ...
                        function previewstar1(pid, onoff) {
                          if (shownstar == '') {
                            if (onoff == 'on') {
                              document.getElementById('greendiv' + pid).style.display = 'block';
                            }
                            if (onoff == 'off') {
                              document.getElementById('greendiv' + pid).style.display = 'none';
                            }
                          }
                        }
                        ...
                        function showstar1(pid) {
                          if (document.getElementById('greendiv' + pid).style.display == 'none' || shownstar == '') {
                            if (shownstar != '') document.getElementById('greendiv' + shownstar).style.display = 'none';
                            document.getElementById('greendiv' + pid).style.display = 'block';
                            document.form.starpid.value = pid;
                            shownstar = pid;
                          } else {
                        ...
                        function phonestatus(uniquekey, yesno) {
                          if (yesno == 'yes') {
                            document.getElementById('phonecall' + uniquekey + 'no').checked = false;
                            document.getElementById('phonecall').value = 'yes';
                          }
                          if (yesno == 'no') {
                            document.getElementById('phonecall' + uniquekey + 'yes').checked = false;
                            document.getElementById('phonecall').value = 'no';
                          }
                        }
                          ...
                          if (patienthascall[patientid]) {
                            if (shownphone == '') {
                              if (document.getElementById('phoneall' + patientid)) {
                                if (onoff == 'on') document.getElementById('phoneall' + patientid).style.display = 'block';
                        ...
                        function bpsubmit() {
                          if (document.form.billorpay.value != '' && document.form.billpayuniquekey.value != "") {
                            ...
                            var arr;
                            if (document.form.billorpay.value == 'billing') arr = billarr;
                            if (document.form.billorpay.value == 'payment') arr = payarr;
                        ...
                        function bpstatus(uniquekey, billpay, status, patient) {
                          if (billpay == 'billing' && status == 'incomplete') {
                            document.getElementById('billingready' + uniquekey).checked = false;
                            document.getElementById('billingcomplete' + uniquekey).checked = false;
                          }
                          if (billpay == 'billing' && status == 'complete') {
                            document.getElementById('billingready' + uniquekey).checked = false;
                            document.getElementById('billingincomplete' + uniquekey).checked = false;
                          }
                          ...
                          if (billpay == 'payment' && status == 'waiting') {
                            document.getElementById('paymentpartial' + uniquekey).checked = false;
                            document.getElementById('paymentfull' + uniquekey).checked = false;
                          }
                          if (billpay == 'payment' && status == 'partial') {
                            document.getElementById('paymentwaiting' + uniquekey).checked = false;
                            document.getElementById('paymentfull' + uniquekey).checked = false;
                          }
                      ...
                      <div id="patienttable0">
                            ...
                            <tr height="25" bgcolor="#FFFFFF">
                              ...
                              <td width="6%" align="center">
                                <table id="patient0">
                                  <tbody>
                                    <tr height="20">
                                      <td style="padding-top:0px;padding-bottom:0px;width:25px;" align="center">
                                        <div style="position:relative;">
                                          <table width="25">
                                            <tbody>
                                              <tr>
                                                <td width="25" align="center">
                                                  <img src="{{ asset('assets/demo2/nlimages/manageicons/starinactive.png') }}" onmouseover="previewstar('0','on');" onmouseout="previewstar('0','off');" onclick="showstar('0')" ondblclick="star('0','off');" height="20"></td>
                                              </tr>
                                            </tbody>
                                          </table>
                                          <div style="text-align: left; position: absolute; top: 23px; height: 230px; width: 300px; display: none; background-color: rgb(253, 255, 122); border: 1px solid rgb(255, 144, 0); z-index: 1; padding: 15px;" id="stardiv0">
                                              ...
                                              <tbody>
                                                <tr valign="bottom">
                                                  ...
                                                  <td width="35" valign="bottom">
                                                    <img id="starbilling0" src="{{ asset('assets/demo2/nlimages/manageicons/starbillingactive.png') }}" onclick="starchange('0','billing');" ondblclick="starsubmit(true);" height="20"></td>
                                                  <td width="35" valign="bottom">
                                                    <img id="starhigh0" src="{{ asset('assets/demo2/nlimages/manageicons/starhighinactive.png') }}" onclick="starchange('0','high');" ondblclick="starsubmit(true);" height="20"></td>
                                                  <td width="35" valign="bottom">
                                                  ...
                                                  <td width="35" valign="bottom">
                                                    <img id="starlow0" src="{{ asset('assets/demo2/nlimages/manageicons/starlowinactive.png') }}" onclick="starchange('0','low');" ondblclick="starsubmit(true);" height="20"></td>
                                                  <td width="30"><a href="javascript:star('0','off');">Unstar</a></td>
                                                </tr>
                                              </tbody>
                                            </table><br>
                                      ...
                                      <td style="padding=top:0px;padding-bottom:0px;" width="25" align="center">
                                        <div style="position:relative;">
                                          ...
                                          <div style="text-align:left;position:absolute;top:23px;left;0px;height:350px;width:300px;display:none;background-color:#d2d2d2;border:1px solid #e62129;z-index:1;padding:15px;" id="phoneall0"></div>
                                        </div>
                                      </td>
                                      <td style="padding-top:0px;padding-bottom:0px;" width="25" align="center">
                                        <div style="position:relative;" class="no-print">
                                          <img src="{{ asset('assets/demo2/nlimages/manageicons/cashicon.png') }}" style="z-index:-1;" onmouseover="showpayment('0');" onmouseout="hidepayment('0');" width="20" height="20">
                                          <div style="text-align:left;position:absolute;top:23px;left;0px;height:275px;width:400px;display:none;background-color:#ebf5e5;border:1px solid #15b100;z-index:1;padding:15px;" id="paymentdrop0">Cost per visit: $15<br><br>Package: Evaluation Sports (up to 60 mins) </div>
                                        </div>
                                      </td>
                                      <td style="padding-top:0px;padding-bottom:0px;" width="25"><img src="{{ asset('assets/demo2/images/spacer.png') }}" width="20" height="20"></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                              <td width="20%" valign="middle"><a href="javascript:showhide('0');" data-id="{{$record->id}}" class="show_hide" style="text-decoration:none;color:black">
                                  <img src="{{ asset('assets/demo2/images/plus.png') }}" id="img0" class="no-print"> {{$record->lastname}},{{$record->firstname }}</a></td>

                              <td width="49%" align="left"><img src="{{ asset('assets/demo2/images/spacer.png') }}" id="billingimg0" width="15" height="15">
                              ...
                              <td width="10%" align="center">
                                ...
                                <table cellspacing="0" cellpadding="0">
                                  <tbody>
                                    <tr>
                                      <td width="20" align="center"><a href="{{ route('edit',$record->id) }}"><img src="{{ asset('assets/demo2/nlimages/patienticonnew.png') }}" class="no-print" height="20"></a></td>
                                      <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                      <td width="20" align="center"><a href="javascript:formsubmit('0','billing.php');"><img src="{{ asset('assets/demo2/nlimages/billingnew.png') }}" class="no-print" height="20"></a></td>
                                    </tr>
                                  </tbody>
                                </table>
                        ...
                        <table style="border-top:1px solid black;display:none;" data-id="{{$record->id}}" class="drop_down{{$record->id}}" width="85%" cellspacing="0" cellpadding="0" bgcolor="#d2d2d0">
                          @if ($index % 2 == 0)
                          <tbody>
                            <tr height="25" style="background: rgb(43 179 226 / 56%);">
                              @else
                          <tbody>
                            <tr height="25" style="background: rgb(43 179 226 / 56%);">
                              @endif
                                    ...
                                    <tr height="20">
                                      <td style="padding-top:0px;padding-bottom:0px;width:25px;" align="center">
                                        <div style="position:relative;">
                                          ...
                                          <div style="text-align: left; position: absolute; top: 23px;  width: 500px; display: none; background: rgb(43, 179, 226);  z-index: 1; padding: 15px;" id="stardiv{{$record->id}}">
                                            <b>Billing</b>:2-2020-19 &nbsp;&nbsp;&nbsp;<input type="radio">Incomplete &nbsp;&nbsp;&nbsp;<input type="radio">Ready &nbsp;&nbsp;&nbsp;<input type="radio">Complete <span style="float:right;"><img src="{{ asset('assets/demo2/images/delete.png') }}" onclick="showstar(<?php echo $record->id; ?>);" width="20" height="20"></span><br><br>
                                            <table cellspacing="0" cellpadding="0">
                                              <tbody>
                                                <tr style="margin-bottom: 10px;">
                                                  <td width="100">Claim:</td>
                                            ...
                                            <input type="hidden" id="starpriority0" value="billing">
                                            <textarea style="width: 333px;height: 43px;" id="starnotes0"></textarea>
                                            <input type="image" src="{{ asset('assets/demo2/nlimages/submitbutton.png') }}">
                                          </div>


                                          <div style="text-align: left; position: absolute; top: 23px;  width: 500px; display: none;     background-color: rgb(235, 245, 229); border: 1px solid rgb(21, 177, 0); z-index: 1; padding: 15px;" id="greendiv{{$record->id}}">
                                            <b>Payment</b>:2-2020-19 &nbsp;&nbsp;&nbsp;<input type="radio">Waiting &nbsp;&nbsp;&nbsp;<input type="radio">Partial &nbsp;&nbsp;&nbsp;<input type="radio">Full <span style="float:right;"><img src="{{ asset('assets/demo2/images/delete.png') }}" onclick="showstar1(<?php echo $record->id; ?>);" width="20" height="20"></span><br><br>
                                            <table cellspacing="0" cellpadding="0">
                                              <tbody>
                                                <tr style="margin-bottom: 10px;">
                                                  <td width="100" style="width: 59%;">Claim:</td>
                                                ...
                                                <tr>
                                                  <td width="100" style="width: 59%;">Date Sent:</td>
                                                ...
                                                <tr>
                                                  <td width="100" style="width: 59%;">Billed Amount:</td>
                                                ...
                                                <tr>
                                                  <td width="80" style="width: 59%;">Insurance Paid:</td>
                                                ...
                                                <tr>
                                                  <td width="80" style="width: 59%;">
                                                    Insurance Payment:(Deductible)</td>

                                                  <td width="35">

                                                    $ <input type="text" value="355" style="    width: 77%;">
                                                  </td>
                                                ...
                                                <tr style="margin-top: 10px;">
                                                  <td width="80" style="width: 59%;"><b>Notes:</b></td>
                                            ...
                                            <p>
                                              <b>On this date:</b>
                                              YTD insurance paid: <b>$ 355</b>
                                              Of $ 1000 deductible, <b>$ 355</b> has been paid. (<b>$ 355</b> remaining)
                                              $ 0 has been paid year to date to office.
                                              Of the $355 for this visit, <b>$ 355</b> went to the deductible.</p>
                                          </div>
                                        </div>
                                      </td>
                                      <td style="padding=top:0px;padding-bottom:0px;" width="25" align="center">
                              ...
                              <td width="20%" valign="middle"><a href="javascript:showhide('0');" class="show_hide" style="text-decoration:none;color:black">
                                  Visits #</a></td>

                              <td width="49%" align="left" style="float: right;">
                                <img src="{{ asset('https://up2speedtraining.com/demo2/nlimages/billing/billingcomplete.png') }}" onmouseover="previewstar('<?php echo $record->id ?>','on');" onmouseout="previewstar('<?php echo $record->id ?>','off');" onclick="showstar('<?php echo $record->id ?>')" ondblclick="star('<?php echo $record->id ?>','off');" id="paymentimg0" width="15" height="15" style="margin-top: 4px;"></td>

                              <td width="12%" align="left" style="float: right;">
                                <a href="" style="    margin-left: 38px;">08/07/2020 </a>
                              </td>


                              <td width="49%" align="left" style="padding-left: 35px;"><img src="{{ asset('assets/demo2/images/spacer.png') }}" id="billingimg0" width="15" height="15">
                                <img src="{{ asset('https://up2speedtraining.com/demo2/nlimages/billing/paymentfull.png') }}" id="paymentimg0" width="15" height="15" onmouseover="previewstar1('<?php echo $record->id ?>','on');" onmouseout="previewstar1('<?php echo $record->id ?>','off');" onclick="showstar1('<?php echo $record->id ?>')" ondblclick="star2('<?php echo $record->id ?>','off');" id="paymentimg0">
                              </td>
                              ...
                              <td width="10%" align="center">
                                ...
                                <table cellspacing="0" cellpadding="0">
                                  <tbody>
                                    <tr>
                                      <td width="20" align="center"><a href="{{ route('edit',$record->id) }}"><img src="{{ asset('https://up2speedtraining.com/demo2/nlimages/notesnew.png') }}" class="no-print" height="20"></a></td>
                                      <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                      <td width="20" align="center"><a href="javascript:formsubmit('0','billing.php');"><img src="{{ asset('https://up2speedtraining.com/demo2/nlimages/progressnew.png') }}" class="no-print" height="20"></a></td>
                                    </tr>
                                  </tbody>
                                </table>
                      ...
                      <script>
                        document.getElementById("phoneall0").innerHTML = '';
                      </script>
  ...
  <script>
    document.getElementById("phoneall1").innerHTML = '';
  </script>
  </center><br>
  <script>
    var patientids = ['0', '3', '6', '10', '11', '9', '8', '5', '2', '4', '1'];
  </script>
  <center>
    <table class="no-print" width="80%">
      <tbody>
        <tr>
          <td width="100%" align="right">
            <img src="{{ asset('assets/demo2/nlimages/showallbutton.png') }}" onclick="javascript:showall()"> <img src="{{ asset('assets/demo2/nlimages/hideallbutton.png') }}" onclick="javascript:hideall()"></td>
        </tr>
      </tbody>
    </table>
  </center><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  <script>
    var firstname = ['Cash', 'Johnny', 'Johnny', 'jimmy', 'Frank', 'Jim', 'Ben', 'Md Sano', 'fsdf', '', 'Poonam'];
  </script>
  <script>
    var lastname = ['Patient', 'Test', 'Sample', 'Buffett', 'Sample', 'Jones', 'Horton', 'Islam', 'dfs', '', ''];
  </script>
  <script>
    //  function showhide()
    //                {
    ...
    document.getElementById('paymentimg0').src = 'assets/demo2/nlimages/billing/paymentwaiting.png';
    document.getElementById('paymentimg3').src = 'assets/demo2/nlimages/billing/paymentwaiting.png';
    document.getElementById('paymentimg6').src = 'nlimages/billing/paymentwaiting.png';
    document.getElementById('paymentimg10').src = 'nlimages/billing/paymentfull.png';
    document.getElementById('paymentimg11').src = 'nlimages/billing/paymentfull.png';
    document.getElementById('paymentimg9').src = 'nlimages/billing/paymentfull.png';
    document.getElementById('paymentimg8').src = 'nlimages/billing/paymentfull.png';
    document.getElementById('paymentimg5').src = 'nlimages/billing/paymentwaiting.png';
    document.getElementById('billingimg2').src = 'nlimages/billing/billingincomplete.png';
    document.getElementById('paymentimg2').src = 'nlimages/billing/paymentwaiting.png';
    document.getElementById('billingimg4').src = 'nlimages/billing/billingincomplete.png';
    document.getElementById('paymentimg4').src = 'nlimages/billing/paymentwaiting.png';
    document.getElementById('billingimg1').src = 'nlimages/billing/billingincomplete.png';
    document.getElementById('paymentimg1').src = 'nlimages/billing/paymentpartial.png';
