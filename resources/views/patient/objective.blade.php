...
<table><tbody><tr><td></td><td width="10"></td><td style="color:white;"><font size="+1"><strong>Patient selected:</strong> {{$data->lastname }},{{$data->firstname }}&nbsp;&nbsp;
    ...
    <div style="display:inline;position:relative;"> <strong>Visit: </strong> <select name="pick" onchange="javascript:pickencounter();">
      ...
      <img src="{{ asset('assets/demo2/nlimages/radioactive.png') }}" height="14"> {{$visit->datemonth}}/{{$visit->dateday}}/{{$visit->dateyear}} <a href="javascript:pickanencounter('03/27/2020','editvisits.php')">
            <img src="{{ asset('assets/demo2/nlimages/edit.png') }}" height="14"></a><br></div>
...
<tr><td "="" align="center">
      ...
      <tr height="35"><td background ="{{ asset('assets/demo2/nlimages/navbgpatient.png')}}" style="background-repeat:no-repeat;background-position:center;"  align="center"><a href="{{URL::to('/preexistingconditions/'.$data->id) }}" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Pre-Existing Conditions</div></a></td></tr>

      <tr height="35"><td background ="{{ asset('assets/demo2/nlimages/navbgpatient.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="
      ...
      <tr height="35"><td background ="{{ asset('assets/demo2/nlimages/navbgpatient.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Billing</div></a></td></tr><tr><td "="" align="center">
            ...
            <img src="{{ asset('assets/demo2/nlimages/visitinformation.png') }}"></td></tr><tr height="35">
                  <td background ="{{ asset('assets/demo2/nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="" style="color:white;text-decoration:none;">
                        ...
                        <div style="width:100%;height:100%">Subjective</div></a></td></tr><tr height="35"><td background ="{{ asset('assets/demo2/nlimages/navbgactive.png')}}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">
                        ...
                        Objective</div></a></td></tr><tr height="35"><td background ="{{ asset('assets/demo2/nlimages/navbg.png')}}"style="background-repeat:no-repeat;background-position:center;"  align="center"><a href="" style="color:white;text-decoration:none;">
                              ...
                              <tr height="35">
                              <td background="{{ asset('assets/demo2/nlimages/navbgexercises.png') }}"style="background-repeat:no-repeat;background-position:center;"  align="center"><a href="{{URL::to('/excercise/'.$data->id) }}" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Exercises</div></a></td></tr><tr height="35">
                              <td background="{{ asset('assets/demo2/nlimages/navbgpatient.png') }}" style="background-repeat:no-repeat;background-position:center;"  align="center">
                              ...
                              <tr height="35"><td background="{{ asset('assets/demo2/nlimages/navbgpatient.png') }}"style="background-repeat:no-repeat;background-position:center;" align="center"><a href="{{URL::to('/algorithm/'.$data->id) }}" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Algorithm</div></a></td></tr>

                              <tr height="35"><td background="{{ asset('assets/demo2/nlimages/navbgpatient.png') }}" style="background-repeat:no-repeat;background-position:center;"  align="center"><a href="{{URL::to('/progress/'.$data->id) }}" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Patient Overview</div></a></td></tr><tr height="35">

                              <td background="{{ asset('assets/demo2/nlimages/navbgpatient.png') }}" style="background-repeat:no-repeat;background-position:center;"  align="center"><a href="{{URL::to('/examsrom/'.$data->id) }}" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Exams</div></a></td></tr>

                              <tr height="35"><td background="{{ asset('assets/demo2/nlimages/navbgpatient.png') }}" style="background-repeat:no-repeat;background-position:center;" align="center"><a href="{{URL::to('/scheduler1/'.$data->id) }}" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Scheduler</div></a></td></tr></tbody></table>
</div>
</td>
...
function changebody(nextorprev){
      ...
      for(var i=0;i<sides.length;i++){
            if(i==index){ document.getElementById('dot'+i).src='/assets/demo2/nlimages/dotactive.png'; document.getElementById(sides[i]).style.display='block'; }
            else{ document.getElementById('dot'+i).src='/assets/demo2/nlimages/dotinactive.png'; document.getElementById(sides[i]).style.display='none'; }
      }
...
function showsubjective(){
      if(document.getElementById('addsubjective').style.display=='block'){
            ...
            document.getElementById('showadd').src="/assets/demo2/nlimages/selectarea.png";
      }
            ...
            document.getElementById('showadd').src="/assets/demo2/nlimages/hidebutton.png";
      }
}
function showdiv(key){
      if(document.getElementById(key+'div').style.display=='none'){
            ...
            document.getElementById(key+'img').src='/assets/demo2/nlimages/minus.png';
      }
      else{
            document.getElementById(key+'div').style.display='none';
            document.getElementById(key+'img').src='/assets/demo2/nlimages/plus.png';
      }
}
...
<br></td><td width="5%">
<img src="{{ asset('assets/demo2/nlimages/17.png') }}" width="25" style="display:inline;"  onclick="javascript:changebody('previous');"></td><td width="40%" align="center" valign="center">
<script src="{{ asset('assets/demo2/mapper.js') }}"></script>
<script>
function show(id){
...
<IMG src="{{ asset('assets/demo2/images/bodyfront.png') }}" class="mapper" name=bodyfront width="210" height="522" border=1 useMap=#frontmap style="display:inline;">
...
<IMG src="{{ asset('assets/demo2/images/bodyback.png') }}" class="mapper" name=bodyback width="210" height="522" border=1 useMap=#backmap style="display:inline;">
...
<IMG src="{{ asset('assets/demo2/images/bodyside.png') }}" class="mapper" name=bodyside width="210" height="522" border=1 useMap=#sidemap style="display:inline;">
...
<td width="5%">
<img src="{{ asset('assets/demo2/nlimages/16.png') }}" width="25" style="display:inline;" onclick="javascript:changebody('next');"></td>
</td>
...
<center><img src="{{ asset('assets/demo2/nlimages/addbutton.png') }}" onclick="javascript:whichsubmitted('subjective');submitcomplaints();"> 
<img src="{{ asset('assets/demo2/nlimages/modifybutton.png') }}" onclick="javascript:modifysubmit()"></center></td></tr></table>
</td></tr></table>
</div>
<table><tr><td><b>Patient Complaints - This Visit</b><br /><br /><img src="{{ asset('assets/demo2/nlimages/selectarea.png') }}" id="showadd" onclick="showsubjective();">
...
<br />
<img src="{{ asset('assets/demo2/nlimages/savebutton.png') }}" height="25" onclick="javascript:whichsubmitted('subjective');saveform();" alt="Save"> <img src="{{ asset('assets/demo2/nlimages/deletebutton.png') }}" onclick="javascript:deleteindex()" alt="Delete"><br /><br /><hr id="objectivehr"><font size="+2">Objective</font> <hr><br><script>
...
<input type="image" src="{{ asset('assets/demo2/nlimages/savebutton.png') }}" height="25" onclick="javascript:whichsubmitted('objective');"> <img src="nlimages/clearbutton.png" alt="Clear" onclick="javascript:clearform();" />
...
<input type="image" src="{{ asset('assets/demo2/nlimages/savebutton.png') }}" height="25" alt="Save" onclick="javascript:whichsubmitted('assessment');"><br><hr id="planhr">
...
<input type="image" src="{{ asset('assets/demo2/nlimages/savebutton.png') }}" height="25" onclick="javascript:whichsubmitted('plan');"><Br>
 <hr>
<font size="+2">Notes</font> <hr>
<br /><textarea cols="150" rows="10" name="notes"></textarea><br /><br>
<input type="image" src="{{ asset('assets/demo2/nlimages/savebutton.png') }}" height="25" onclick="javascript:whichsubmitted('plan');"></form>    </td></tr></table></td></tr></table></body>
