...
<img src="{{ asset('assets/demo2/nlimages/areas/anteriorleg.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/anteriorknee.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/bottomfoot.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/lateralanklefoot.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/lateralknee.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/medialanklefoot.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/medialknee.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/posteriorankle.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/posteriorknee.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/posteriorleg.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/superiorknee.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/superiorknee2.jpeg') }}" width="500">
<img src="{{ asset('assets/demo2/nlimages/areas/topoffoot.jpeg') }}" width="500">    </td></tr></tbody></table></td></tr></tbody></table>
</form></body></html>