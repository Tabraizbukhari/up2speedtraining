...
var categories=['EXERCISE','MOBILITY','STRETCHING','CARDIO','SPORT','ALL'];
	...
	var categoryselect='<td><img src="/assets/demo2/nlimages/exerciseicons/mobilityback.png" width="25" height="25" onclick="show(\'Categories\');show(\'MOBILITY\');"></td><td><img src="/assets/demo2/nlimages/exerciseicons/cardioback.png" width="25" height="25" onclick="show(\'Categories\');show(\'CARDIO\');"></td><td><img src="/assets/demo2/nlimages/exerciseicons/exerciseback.png" width="25" height="25" onclick="show(\'Categories\');show(\'EXERCISE\');"></td><td><img src="/assets/demo2/nlimages/exerciseicons/stretchingback.png" width="25" height="25" onclick="show(\'Categories\');show(\'STRETCHING\');"></td><td><img src="/assets/demo2/nlimages/exerciseicons/sportback.png" width="25" height="25" onclick="show(\'Categories\');show(\'SPORT\');"></td>';
	var lastshown;
...
<div id="ROLLERheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>IT-Band','mobility','','IT-Band');">IT-Band</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>Quad','mobility','','Quad');">Quad</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>Adductors','mobility','','Adductors');">Adductors</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>Calf','mobility','','Calf');">Calf</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>Ant Tib','mobility','','Ant Tib');">Ant Tib</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>Hamstring','mobility','','Hamstring');">Hamstring</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>Glute','mobility','','Glute');">Glute</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>ROLLER</u><br>Back','mobility','','Back');">Back</td></tr></table></div>
	<div id="BALLheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>BALL</u><br>Psoas','mobility','','Psoas');">Psoas</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>BALL</u><br>Glute','mobility','','Glute');">Glute</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>BALL</u><br>Pec / Chest','mobility','','Pec / Chest');">Pec / Chest</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>BALL</u><br>Foot','mobility','','Foot');">Foot</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>BALL</u><br>Forearm','mobility','','Forearm');">Forearm</td></tr></table></div>
	<div id="COMBO- ROLLER BALL OR STRAPheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>COMBO- ROLLER BALL OR STRAP</u><br>Glute','mobility','','Glute');">Glute</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>COMBO- ROLLER BALL OR STRAP</u><br>Back and Glute','mobility','','Back and Glute');">Back and Glute</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>COMBO- ROLLER BALL OR STRAP</u><br>Ant. Chain','mobility','','Ant. Chain');">Ant. Chain</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>COMBO- ROLLER BALL OR STRAP</u><br>Post. Chain','mobility','','Post. Chain');">Post. Chain</td><td width="100"></td></tr></table></div>
	<div id="1/2 SURFACEheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>1/2 SURFACE</u><br>Post. Chain Stretch','mobility','','Post. Chain Stretch');">Post. Chain Stretch</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>1/2 SURFACE</u><br>Calves','mobility','','Calves');">Calves</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>1/2 SURFACE</u><br>Hamstrings','mobility','','Hamstrings');">Hamstrings</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>1/2 SURFACE</u><br>Lower Back','mobility','','Lower Back');">Lower Back</td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>1/2 SURFACE</u><br>Positive Shin','mobility','','Positive Shin');">Positive Shin</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>1/2 SURFACE</u><br>Balance- Horizontal ','mobility','','Balance- Horizontal ');">Balance- Horizontal </td><td background="{{ asset('assets/demo2/nlimages/greenback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>1/2 SURFACE</u><br>Balance- Perpendicular','mobility','','Balance- Perpendicular');">Balance- Perpendicular</td></tr></table></div>
	<div id="CARDIOheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Hiking','cardio','','Hiking');">Hiking</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Recumbent Bike','cardio','','Recumbent Bike');">Recumbent Bike</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Jump Rope','cardio','','Jump Rope');">Jump Rope</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Rower','cardio','','Rower');">Rower</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Running','cardio','','Running');">Running</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Swimming','cardio','','Swimming');">Swimming</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Stair Climber','cardio','','Stair Climber');">Stair Climber</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Treadmill','cardio','','Treadmill');">Treadmill</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Versa Climber','cardio','','Versa Climber');">Versa Climber</td><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Walking','cardio','','Walking');">Walking</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/orangeback.png') }}
" width="100" height="100" align="center" onclick="populatelist('<u>CARDIO</u><br>Assult Air Bike','cardio','','Assult Air Bike');">Assult Air Bike</td></tr></table></div>
	...
	<div id="LADDER DRILLSheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>LADDER DRILLS</u><br>Ladder','sport','','Ladder');">Ladder</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>LADDER DRILLS</u><br>Lunges','sport','','Lunges');">Lunges</td><td width="100"></td><td width="100"></td><td width="100"></td></tr></table></div>
	<div id="GAIT TRAININGheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>GAIT TRAINING</u><br>Heel - Mid Stance - Toe Off','sport','','Heel - Mid Stance - Toe Off');">Heel - Mid Stance - Toe Off</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>GAIT TRAINING</u><br>Walking','sport','','Walking');">Walking</td><td width="100"></td><td width="100"></td><td width="100"></td></tr></table></div>
	<div id="JUMPINGheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>JUMPING</u><br>Single Leg','sport','','Single Leg');">Single Leg</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>JUMPING</u><br>Double','sport','','Double');">Double</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>JUMPING</u><br>Bench / Box Crunch','sport','','Bench / Box Crunch');">Bench / Box Crunch</td><td width="100"></td><td width="100"></td></tr></table></div>
	<div id="BASKETBALLheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>#1','sport','','#1');">#1</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>#2','sport','','#2');">#2</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>#3','sport','','#3');">#3</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>#4','sport','','#4');">#4</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>#5','sport','','#5');">#5</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>DRIBBLING','sport','','DRIBBLING');">DRIBBLING</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>1','sport','','1');">1</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>2','sport','','2');">2</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>3','sport','','3');">3</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>4','sport','','4');">4</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>5','sport','','5');">5</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>6','sport','','6');">6</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>7','sport','','7');">7</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>8','sport','','8');">8</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>9','sport','','9');">9</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>10','sport','','10');">10</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASKETBALL</u><br>SHOOTING MACHINE','sport','','SHOOTING MACHINE');">SHOOTING MACHINE</td></tr></table></div>
	<div id="BASEBALLheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASEBALL</u><br>PITCHER','sport','','PITCHER');">PITCHER</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASEBALL</u><br>CATCHER','sport','','CATCHER');">CATCHER</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASEBALL</u><br>INFIELDER','sport','','INFIELDER');">INFIELDER</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASEBALL</u><br>OUTFIELDER','sport','','OUTFIELDER');">OUTFIELDER</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>BASEBALL</u><br>BATTING','sport','','BATTING');">BATTING</td><script>if(subheadings['THROWING']==null) subheadings['THROWING']=[];
		...
		subheadings['THROWING'].push('60 YRDS');</script></tr><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="showsubcategories('BASEBALL','THROWING','sport','red')">THROWING<br>(<u>more</u>)</td></tr></table></div>
	<div id="FOOTBALLheadingdiv" style="display:none"><table cellspacing="10" cellpadding="0" style="color:white" width="550"><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>OFFENSE','sport','','OFFENSE');">OFFENSE</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>QB','sport','','QB');">QB</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>RB','sport','','RB');">RB</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>WR','sport','','WR');">WR</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>TE','sport','','TE');">TE</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>OL','sport','','OL');">OL</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>CENTER','sport','','CENTER');">CENTER</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>LONG SNAPPER','sport','','LONG SNAPPER');">LONG SNAPPER</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>DEFENSE','sport','','DEFENSE');">DEFENSE</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>DL','sport','','DL');">DL</td></tr><tr><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>DT','sport','','DT');">DT</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>LB','sport','','LB');">LB</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
 width="100" height="100" align="center" onclick="populatelist('<u>FOOTBALL</u><br>CB','sport','','CB');">CB</td><td background="{{ asset('assets/demo2/nlimages/redback.png') }}"
...
</td><td valign="top"><center><br><br><Br><br><form action="exercises.php" method="post" name="exerciseform">
...
<tr style="border-top:1px solid #696969;border-bottom:1px solid #696969;padding:10px"><td style="padding:0px;" colspan="7" align="center"><input style="width:455px;background-image:url('/assets/demo2/nlimages/redback.png');background-size:450px 35px;color:white;font-size:24px;text-align:center;" name="exercisename" value="WORKOUT"></td><td colspan="5" bgcolor="black" align="center"><font color="white" size="+2">09/07/2020</font></td></tr>
<tr style="background-color:black;color:white;"><td width="15"></td><td width="15"></td>
    ...
    <br /><div id="nosavediv">
    <input type="image" src="{{ asset('assets/demo2/nlimages/savebuttoninactive.png') }}"></div><div id="savediv" style="display:none;">
    <input type="image" src="{{ asset('assets/demo2/nlimages/savebutton.png') }}" height="25"></div></form>
 <form method="post" action="exercises.php" name="emailform"><input type="hidden" name="emailsubmit" id="emailsubmit">
...
<img src="{{ asset('assets/demo2/nlimages/sendbutton.png') }}" onclick="javascript:sendemail();"></form>
</center></td></tr>
