...
<form name="encform" enctype="multipart/form-data" 
	action="{{ route('udateinsuranceinfo',$data->id) }}" method="POST">
	@csrf
    @method('PUT')
...
<tr><td "="" align="center">
	<img src="{{ asset('assets/demo2/nlimages/patientinformation.png') }}"></td></tr><tr height="35">
		<td class="tdbg" background="{{ asset('assets/demo2/nlimages/navbgpatient.png')}}" style="background-repeat:no-repeat;background-position:center;" id="ientinfo.phptd" align="center"><b><a href="" style="color:white;text-decoration:none;"><div style="width:100%;height:100%">Patient Info</div></a></b></td></tr>
...
function showhide(id,phone){
	if(document.getElementById('encounter'+id).style.display=='block'&&phone!='phone'){
		...
		document.getElementById('img'+id).src='/assets/demo2/images/plus.png';
...
function hideall(){
	for(var i=0;i<patientids.length;i++){
		...
		document.getElementById('img'+patientids[i]).src='/assets/demo2/images/plus.png';
...
function deleteapatient(patientid,firstname,lastname){
	if(window.confirm('Are you sure you want to delete all data for '+firstname+' '+lastname+'?')){
		if(window.confirm('Please confirm: this will delete all visits and associated data for '+firstname+' '+lastname+'!')){
			document.form.patientid.value=patientid;
			document.form.deletepatient.value="true";
			if(patientid=='11') document.form.action='manage.php?clear=true';
			document.form.submit();
		}
	}
}
...
<table class="no-print"><tbody><tr><td align="center"><a href="newpatient.php"><img src="{{ asset('assets/demo2/nlimages/newpatient.png') }}" height="50"><br><br>New Patient</a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="center"><a href="javascript:newencountersubmit();"><img src="{{ asset('assets/demo2/nlimages/newvisit.png') }}" height="50"><br><br>New Visit</a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td align="center"><a href="javascript:printsubmit();">
	<img src="{{ asset('assets/demo2/nlimages/printicon.png') }}" height="50"><br><br>Print</a></td></tr></tbody></table>
...
<select name="datemonth"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9" selected="">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>
...
Select Dates: 
<select name="onor">
<option value="All" selected="">All</option><option value="On">On</option><option value="On or Before">On or Before</option><option value="On or After">On or After</option></select>
...
</tr></tbody></table> </td></tr></tbody></table></td><td valign="top" align="center"><br>
<input type="image" alt="Filter" src="{{ asset('assets/demo2/nlimages/filterbutton.png') }}" width="101"></td></tr></tbody></table>
</td></tr></tbody></table><br>
</center></form></div>
<center><table class="no-print" width="80%"><tbody><tr><td>
<table><tbody><tr><td><b>Filtered By: </b> Patient: , Testvisit</td><td width="30">&nbsp;</td><td><a href="manage.php?clear=true">
	<img src="{{ asset('assets/demo2/nlimages/clearbuttonorange.png') }}"></a></td></tr></tbody></table><br>Select a patient to view data, or select an option to jump to that section: <br>	<br>
<script>
function submitsort(){
	if("Filter"!="Filter")
...
<form name="form" action="manage.php" method="post" autocomplete="off" onsubmit="javascript:starsubmit();bpsubmit();phonesubmit();">
	 <input type="hidden" name="filter" value="Filter">     <input type="hidden" name="passfilterpatient" value="11">
...
function showhideyear(pid,year){
	if(document.getElementById('patientid'+pid+'year'+year)){
		if(document.getElementById('patientid'+pid+'year'+year).style.display=='none'){
			...
			document.getElementById('patientid'+pid+'year'+year+'plus').src='/assets/demo2/images/plus.png';
		}
	}
}
</script>
<div id="patienttable11"><table style="border-top:1px solid black;" width="85%" cellspacing="0" cellpadding="0" bgcolor="#d2d2d0"><tbody><tr height="25">
	<td style="background-color:white;border-top:2px solid black;" width="3%" align="center"><b>1</b></td><td width="2%" align="center"><input type="radio" name="patientselect" value="11" class="no-print" onclick="selectfilterpatient('11');" checked=""></td>
	<td width="6%" align="center"><table id="patient11"><tbody><tr height="20"><td style="padding-top:0px;padding-bottom:0px;width:25px;" align="center"><div style="position:relative;"><table width="25"><tbody><tr><td width="25" align="center">
	<img src="{{ asset('assets/demo2/nlimages/manageicons/starinactive.png') }}" onmouseover="previewstar('11','on');" onmouseout="previewstar('11','off');" onclick="showstar('11')" ondblclick="star('11','on');" width="20" height="20"></td></tr></tbody></table><div style="text-align:left;position:absolute;top:23px;left;0px;
				height:230px;width:300px;display:none;background-color:#fdff7a;border:1px solid #ff9000;z-index:1;padding:15px;" id="stardiv11">
				(Double-click to star/unstar)<span style="float:right;"><img src="{{ asset('assets/demo2/images/delete.png') }}" onclick="showstar('11');" width="20" height="20"></span><br><br>
				<table cellspacing="0" cellpadding="0"><tbody><tr valign="bottom">
					<td width="80">Priority:</td>
					<td width="35" valign="bottom">
					<img id="starbilling11" src="{{ asset('assets/demo2/nlimages/manageicons/starbillinginactive.png') }}" onclick="starchange('11','billing');" ondblclick="starsubmit(true);" height="20"></td>
					<td width="35" valign="bottom">
					<img id="starhigh11" src="{{ asset('assets/demo2/nlimages/manageicons/starhighinactive.png') }}" onclick="starchange('11','high');" ondblclick="starsubmit(true);" height="20"></td>
					<td width="35" valign="bottom">
					<img id="starmedium11" src="{{ asset('assets/demo2/nlimages/manageicons/starmediuminactive.png') }}" onclick="starchange('11','medium');" ondblclick="starsubmit(true);" height="20"></td>
					<td width="35" valign="bottom">
					<img id="starlow11" src="{{ asset('assets/demo2/nlimages/manageicons/starlowinactive.png') }}" onclick="starchange('11','low');" ondblclick="starsubmit(true);" height="20"></td></tr></tbody></table><br>
					<input type="hidden" id="starpriority11" value="high">
					<center><textarea style="width:250px;height:75px;" id="starnotes11"></textarea><br><br>
	...
	<img id="phonecallicon11" src="{{ asset('assets/demo2/nlimages/manageicons/phoneinactive.png') }}" onmouseover="previewphoneall('11','on');" onmouseout="previewphoneall('11','off');" onclick="showphoneall('11');" width="20" height="20">
	 <div style="text-align:left;position:absolute;top:23px;left;0px;height:350px;width:300px;display:none;background-color:#d2d2d2;border:1px solid #e62129;z-index:1;padding:15px;" id="phoneall11"></div></div></td><td style="padding-top:0px;padding-bottom:0px;" width="25" align="center">
	 	<img src="{{ asset('assets/demo2/nlimages/spacer.png') }}" width="20" height="20"></td><td style="padding-top:0px;padding-bottom:0px;" width="25"><img src="{{ asset('assets/demo2/images/spacer.png') }}" width="20" height="20"></td></tr></tbody></table></td>
	<td width="20%" valign="middle"><a href="javascript:showhide('11');" style="text-decoration:none;color:black">
	<img src="{{ asset('assets/demo2/images/plus.png') }}" id="img11" class="no-print">{{$data->lastname}},{{$data->firstname}}</a></td><td width="49%" align="left">
		<img src="{{ asset('assets/demo2/images/spacer.png') }}" id="billingimg11" width="15" height="15"> 
		<img src="{{ asset('assets/demo2/nlimages/billing/paymentfull.png') }}" id="paymentimg11" width="15" height="15"></td>
	<td width="10%" align="center">
	
	<table cellspacing="0" cellpadding="0"><tbody><tr><td width="20" align="center"><a href="javascript:formsubmit('11');">
	<img src="{{ asset('assets/demo2/nlimages/patienticonnew.png') }}" class="no-print" height="20"></a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td width="20" align="center"><a href="javascript:formsubmit('11','billing.php');">
	<img src="{{ asset('assets/demo2/nlimages/billingnew.png') }}" class="no-print" height="20"></a></td></tr></tbody></table>
	
	</td>
	<td width="10%" align="center"><img src="{{ asset('assets/demo2/nlimages/deletenew.png') }}" class="no-print" onclick="deleteapatient('11','Testvisit','');" height="20"></td></tr></tbody></table></div><div id="encounter11" style="display: none;"><table width="80%" cellspacing="0" cellpadding="5" border="1"><tbody><tr><td width="5%"></td><td width="97%">No visits found for those dates!</td></tr></tbody></table></div><script>document.getElementById("phoneall11").innerHTML='';</script><script>showhide("11");</script></center><br>
<script>var patientids=['11'];
</script>
<center><table class="no-print" width="80%"><tbody><tr><td width="100%" align="right"><img src="{{ asset('assets/demo2/nlimages/showallbutton.png') }}" onclick="javascript:showall()"> 
	<img src="{{ asset('assets/demo2/nlimages/hideallbutton.png') }}" onclick="javascript:hideall()"></td></tr></tbody></table></center><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<script> var firstname=['Cash','Johnny','Johnny','jimmy','Frank','Jim','Ben','Md Sano','','Testvisit'];</script><script> var lastname=['Patient','Test','Sample','Buffett','Sample','Jones','Horton','Islam','',''];</script><script>
...
document.getElementById('paymentimg11').src='/assets/demo2/nlimages/billing/paymentfull.png';document.getElementById('showbillingpayment').style.display='block';
