...
</script><link href="{{ asset('assets/demo2/styles.css') }}" type="text/css" rel="stylesheet"></head>
...
@endforeach
	...
	<a href="{{ route('portalhome') }}" style="color:white;font-size:18px;">
		<img src="{{ asset('assets/demo2/nlimages/patientportal.png') }}" style="display:inline;" width="65"></a></td><td style="border-left:none;" width="4%" align="right"><a href="{{ route('patient')}}">
			<img src="{{ asset('assets/demo2/images/spacer.png') }}" style="display:inline;" width="65"></a></td></tr>
...
<td style="width:50px;padding:0px;" valign="middle" align="center"><a href="addclient.php?print=true"><img src="{{ asset('assets/demo2/nlimages/print.png') }}" width="40"></a></td>
